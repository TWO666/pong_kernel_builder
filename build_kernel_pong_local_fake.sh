...
echo "===== Nothing Phone 2 (5.10) KernelSU Local Build Script (Clang 20) ====="
...
sudo apt-get install --no-install-recommends -y \
    ...
    python3 python-is-python3 bc libssl-dev libelf-dev aria2 unzip faketime cpio ccache
...
echo ">>> Modifying timestamps in kernel source..."
# 1. Modify scripts/mkcompile_h script
...
# 2. Create fixed compilation time header file
...
echo ">>> Deterministic build timestamp setup completed"
...
echo ">>> GKI compiling with faketime (Image)..."
